			...
			<div className='flex flex-col items-center justify-center px-6 pt-32 pb-12 max-sm:px-0'>
				<div className='w-full max-w-[800px]'>
					...
					<div className='mt-8 flex items-center justify-center gap-6'>
						<motion.a
							href='https://github.com/cecil-luke/2025-blog-public'
							target='_blank'
							rel='noreferrer'
				...
				{isEditMode ? (
					<>
						<motion.button
							...
							disabled={isSaving}
							className='rounded-xl border bg-card backdrop-blur-sm px-6 py-2 text-sm'>
							取消
						</motion.button>
						<motion.button
							whileHover={{ scale: 1.05 }}
					...
					!hideEditButton && (
						<motion.button
							...
							className='rounded-xl border bg-card backdrop-blur-sm px-6 py-2 text-sm backdrop-blur-sm transition-colors hover:bg-card/80'>
							编辑
						</motion.button>
					)
				)}
